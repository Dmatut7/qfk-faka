...
const MERCHANT = ['数据概览', '商品管理', '店铺装修', '分类管理', '卡密管理', '订单管理', '投诉处理', '优惠券', '满减满折', '钱包 / 提现'];
const ADMIN = ['仪表盘', '商户审核', '支付渠道', '提现审核', '对账报表', '内容管理', '禁售目录', '邀请码', '订单(跨商户)', '商品(跨商户)', '投诉仲裁', '买家黑名单', '平台配置', '操作日志', '异常日志', '大屏数据', '任务计划'];
