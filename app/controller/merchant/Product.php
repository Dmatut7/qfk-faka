...
class Product extends BaseApiController
{
    ...
    {
        $d = $this->params(['category_id', 'title', 'sku', 'description', 'image', 'price', 'market_price', 'discount_price', 'discount_start', 'discount_end', 'type', 'goods_type', 'min_buy', 'max_buy', 'delivery_message', 'purchase_notice', 'show_stock_type', 'status', 'sort']);
        $this->validate($d, [
    ...
    {
        $d = $this->params(['category_id', 'title', 'sku', 'description', 'image', 'price', 'market_price', 'discount_price', 'discount_start', 'discount_end', 'type', 'goods_type', 'min_buy', 'max_buy', 'delivery_message', 'purchase_notice', 'show_stock_type', 'sort']);
